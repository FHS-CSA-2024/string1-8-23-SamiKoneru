...
public class String1
{
    ...
    public String extraEnd(String str) {
        ...
        return newStr + newStr + newStr;    //don't know if there's a way to do this in a more compact way, 3*str doesn't work
    }
    ...
    public String deFront(String str) {  
        ...
        if (!str.substring(1,2).equals("b")) {
            if (finalStr.length() != str.length()) {
                ...
                finalStr = finalStr.substring(0,1) + finalStr.substring(2);
            }
        }
        return finalStr;
    }
